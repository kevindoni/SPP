            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-options"> 
                        <a href="{{ route('tabungan.cetak', $siswa->id) }}" target="_blank" class="btn btn-outline-primary mr-1">Cetak</a>
                        <a href="{{ route('tabungan.siswa.export', $siswa->id) }}" target="_blank" class="btn btn-outline-primary">Export</a>
                    </div>
                    @endif
                </div>
                <div class="card-body">
        ...
        <div class="col-6 col-md-6">
            <div class="card">
                <div class="card-header">
                    ...
                    @if(!$siswa->is_yatim)
                    <div class="card-options">
                        <input class="form-control mr-2" type="text" name="dates" style="max-width: 100px" id="daterange" value="{{ now()->subDay(7)->format('m-d-Y')." - ".now()->format('m-d-Y') }}">
                        <button id="btn-cetak-spp" class="btn btn-outline-primary mr-1" value="{{ $siswa->id }}">Cetak</button>
                        <button id="btn-export-spp" class="btn btn-outline-primary" value="{{ $siswa->id }}">Export</button>
                    </div>
                    @endif
                </div>
                <div class="card-body">
