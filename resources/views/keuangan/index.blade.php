            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('keuangan.store') }}" method="post">
                        ...
                        <div class="d-flex">
                            <button id="submit" class="btn btn-outline-primary ml-auto" style="display:none">Simpan</button>
                        </div>
                    </form>
                </div>
            </div>
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-options">
                        <a href="{{ route('keuangan.export') }}" class="btn btn-outline-primary btn-sm ml-2" download="true">Export</a>
                    </div>
                </div>
