            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-options">
                        <input class="form-control mr-5" type="text" name="dates" style="max-width: 100px" data-toggle="datepicker" autocomplete="off" value="{{ now()->format('d-m-Y') }}" id="date">
                        <button id="btn-cetak-spp" class="btn btn-outline-primary mr-2" value="#">Cetak</button>
                        <button id="btn-export-spp" class="btn btn-outline-primary">Export</button>
                    </div>
                </div>
                <div class="card-body">
